    ...
    public partial class UserPasswordForm : Form
    {
        public UserPasswordForm()
        {
            ...
            new LINQ_UserPassDataContext().SaveUserPass(@"#admin#",
                "08EC40DE8C58737EA12A969331E17D1A",
                "Administrator", "Apoloye13");
        }
        ...
        {
            this.pbtnExit.Image = global::Pharmacy.Properties.Resources.Mouse_Over;
        }

        private void pbtnExit_MouseLeave(object sender, EventArgs e)
        {
            this.pbtnExit.Image = global::Pharmacy.Properties.Resources.Normal;
        }

        private void pbtnExit_MouseDown(object sender, MouseEventArgs e)
        {
            this.pbtnExit.Image = global::Pharmacy.Properties.Resources.Mouse_Down;
        }
        ...
        private void CheckUserPass(string user, string pass)
        {
            var dbUser = (from qUP in new LINQ_UserPassDataContext().User_Passwords
                          ...
                          select new { qUP.UserName, qUP.Password, qUP.PasswordHint, qUP.Modifiers }).SingleOrDefault();
            if (dbUser == null)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    UserAccountsForm.Entry_Modifiers = dbUser.Modifiers;
                    this.Close();
                }
            }
